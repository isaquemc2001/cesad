                ...
                <div class="offcanvas-body">
                    ...
                    <div class="sidebar-responsivo flex-column shadow" style="width: 4.5rem;">
                        ...
                        <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
                            <li class="nav-item">
                                <a href="tecnico" class="nav-link active py-3 border-bottom" aria-current="page" title="Página Inicial" data-bs-toggle="tooltip" data-bs-placement="right">
                            ...
                            <li>
                                <a href="meuschamados" class="nav-link py-3 border-bottom" title="Seus Chamados" data-bs-toggle="tooltip" data-bs-placement="right">
