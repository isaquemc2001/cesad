            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col">
                            <h5>Título</h5>
                            <input type="text" class="form-control mb-4" name="Titulo" required>

                            <h5>Tipo de Erro</h5>
                            <select id="" class="form-select mb-4" name="tipoErro" required>
...
<input type="text" type="hidden" value="{{ $errors }}" name="Errors">
