            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col">
                            <h5>Título</h5>
                            <input type="text" class="form-control mb-4" name="Titulo" value={{ old('Titulo') }} onkeypress=@php echo $this.mask('000.000.000.00') @endphp>

                            <h5>Tipo de Erro</h5>
                            <select id="" class="form-select mb-4" name="tipoErro">
                                <option value="1" {{ old('tipoErro') == 1 ? 'selected' : ''}} >Dificuldade de acesso</option>
                                <!--1-->
                                <option value="2" {{ old('tipoErro') == 2 ? 'selected' : ''}}>Cadastro de dados</option>
                                <!--2-->
                            </select>

                            <h5>Anexo</h5>
                            <input class="form-control" id="formFileSm" type="file" name="Anexo" value={{ old('Anexo') }}>
                        ...
                        <input type="text" value="@php echo $status = "2";  @endphp" name="Status" hidden>
