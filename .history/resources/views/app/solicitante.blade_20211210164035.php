...
<script>
                ...
                <div class="offcanvas-body">
                    ...
                    <div class="sidebar-responsivo flex-column shadow" style="width: 4.5rem;">
                        ...
                        <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
                            <li class="nav-item">
                                <a href="/prototipo2/modulos/solicitante/index-solicitante.phtml" class="nav-link active py-3 border-bottom" aria-current="page" title="Página Inicial" data-bs-toggle="tooltip" data-bs-placement="right">
                            ...
                            <li>
                                <a class="nav-link py-3 border-bottom" title="Novo Chamado" data-bs-toggle="modal" data-bs-target="#cadastrar-chamado" data-bs-placement="right">
                ...
                <li>
                    <div class="dropdown dropstart">
                        <a href="#" class="d-flex" type="button" id="dropdownMenu2" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="{{ asset('images/I.png')}}" class="btn-nav btn-perfil" href="#" title="Acesso Rápido" role="button" id="dropdown" aria-expanded="false">
                        </a>
    ...
    <div class="side-bar flex-column shadow" style="width: 4.5rem;">
        ...
        <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
            ...
            <li>
                <a class="nav-link btn py-3 border-bottom" title="Novo Chamado" data-bs-toggle="modal" data-bs-target="#cadastrar-chamado" data-bs-placement="right">
                    <svg class="bi" width="24" height="24" role="img" aria-label="Products">
                        <use xlink:href="#new" />
                    </svg>
                </a>
    ...
    <form action="/prototipo2/modulos/controllers/cadastrar-chamado.php" method="POST">
        <div class="modal fade" id="cadastrar-chamado" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select id="" class="form-select mb-4" name="tipoErro">
                                    <option value="1">Dificuldade de acesso</option><!--1-->
                                    <option value="2">Cadastro de dados</option><!--2-->
                                </select>
                            ...
                            <div class="col">
                                <h5>Descrição</h5>
                                <textarea class="form-control" id="textarea-disabled" rows="14" name="Descricao"></textarea>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 col-xxl-2 d-flex justify-content-end" style="height: 50%;">
                <div class="btn-add btn btn-success" title="Novo Chamado" data-bs-toggle="modal" data-bs-target="#cadastrar-chamado">Novo Chamado</div>
            </div>
        </div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="btn-table btn badge bg-warning ml-2" data-bs-toggle="modal" data-bs-target="#editar-chamado">Editar</div>
                            </td>
                        </tr>
                        <tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            <h5>Descrição</h5>
                            <textarea class="form-control mb-4" id="textarea-disabled" rows="7" disabled>What is Lorem Ipsum?
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <button type="button" class="btn-table btn badge bg-primary ml-4" data-bs-dismiss="modal">Histórico de Atualização</button>
                                </div>
                            </div>
                            <textarea class="form-control" id="textarea-disabled" rows="7" disabled>What is Lorem Ipsum?
                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
    ...
    <div class="modal fade" id="editar-chamado" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
