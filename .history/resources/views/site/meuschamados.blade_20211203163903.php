...
<body>
                ...
                <div class="offcanvas-body">
                    ...
                    <div class="sidebar-responsivo flex-column shadow" style="width: 4.5rem;">
                        ...
                        <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
                            ...
                            <li>
                                <a href="/prototipo2/modulos/tecnico/chamados-tecnico.phtml" class="nav-link active py-3 border-bottom" title="Seus Chamados" data-bs-toggle="tooltip" data-bs-placement="right">
    ...
    <div class="side-bar flex-column shadow" style="width: 4.5rem;">
        ...
        <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
            <li class="nav-item">
                <a href="/prototipo2/modulos/tecnico/index-tecnico.phtml" class="nav-link py-3 border-bottom" aria-current="page" title="Página Inicial" data-bs-toggle="tooltip" data-bs-placement="right">
                    <svg class="bi" width="24" height="24" role="img" aria-label="Home">
                        <use xlink:href="#home" />
                    </svg>
                </a>
